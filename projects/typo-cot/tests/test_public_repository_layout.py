...
PUBLIC_SOURCE_FILES = {
    ...
    Path("src/typo_cot/evaluation/audit_extractor.py"),
    ...
    Path("src/typo_cot/experiments/rebuttal_v2/__init__.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/cli.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/answer_audit.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/artifacts.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/artifact_io.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/coordinates.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/donor_artifacts.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/donors.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/input_audit.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/input_spans.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/input_tokenization.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/annotations.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/identity.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/plan_artifacts.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/planning.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/runtime_lock.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/schemas.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/semantic_labels.py"),
    Path("src/typo_cot/experiments/rebuttal_v2/source.py"),
