# Legacy development README (non-canonical)

> This file preserves the former Step0/Exp1–20 development notes. It contains
> intermediate hypotheses, machine-specific paths, and experiments that are not
> part of the final paper. Do not use it as a reproduction guide. The final PDF
> and [`paper-experiments.md`](paper-experiments.md) take precedence.
