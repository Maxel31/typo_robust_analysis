...
```bash
python scripts/prepare_few_shot.py --output-dir data/few_shot --seed 42
```
...
# 量子化モデル
python experiments/run_eval.py --config configs/quant_eval.yaml \
...
```bash
# Jupyter notebook
jupyter lab analysis/analyze.ipynb
```
