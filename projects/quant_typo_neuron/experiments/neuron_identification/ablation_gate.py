...
STATUS: stub — 実装は feature/quant_typo_neuron/neuron_identification-ablation-gate。
...
def main() -> None:
    ...
    raise NotImplementedError(
        "feature/quant_typo_neuron/neuron_identification-ablation-gate で実装予定 (config=%s, overrides=%s)"
